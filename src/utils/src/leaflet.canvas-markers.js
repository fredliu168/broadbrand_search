        ...
        for (; r > e;) {
          if (r - e > 600) {
            var s = r - e + 1, h = a - e + 1, l = Math.log(s), c = .5 * Math.exp(2 * l / 3),
              ...
              u = Math.max(e, Math.floor(a - h * c / s + m)), f = Math.min(r, Math.floor(a + (s - h) * c / s + m));
            n(i, a, u, f, o)
          }
          var d = i[a], _ = e, p = r;
  ...
  t.exports = function (t) {
    var n = (t.Layer ? t.Layer : t.Class).extend({
      initialize: function (n) {
        ...
        var e = this._map.latLngToContainerPoint(i), r = n.options.icon.options.iconSize, o = r[0] / 2, s = r[1] / 2,
          h = [{minX: e.x - o, minY: e.y - s, maxX: e.x + o, maxY: e.y + s, data: n}, {
            minX: i.lng,
            minY: i.lat,
            maxX: i.lng,
            maxY: i.lat,
        ...
        if (t && this._context.clearRect(0, 0, this._canvas.width, this._canvas.height), this._map && this._latlngMarkers) {
          ...
          n._latlngMarkers.search(e).forEach(function (t) {
            var a = n._map.latLngToContainerPoint(t.data.getLatLng()), e = t.data.options.icon.options.iconSize,
              r = e[0] / 2, o = e[1] / 2,
