!function (t) {
    ...
    function s(t, n, i, a, e) {
        e || (e = g(null)), e.minX = 1 / 0, e.minY = 1 / 0, e.maxX = -1 / 0, e.maxY = -1 / 0;
    ...
    function d(t, n) {
        var i = Math.max(t.minX, n.minX), a = Math.max(t.minY, n.minY), e = Math.min(t.maxX, n.maxX),
    ...
    e.prototype = {
        all: function () {
            ...
            if (!p(t, n)) return i;
            for (var e, r, o, s, h = []; n;) {
                for (e = 0, r = n.children.length; e < r; e++) o = n.children[e], p(t, s = n.leaf ? a(o) : o) && (n.leaf ? i.push(o) : _(t, s) ? this._all(o, i) : h.push(o));
                n = h.pop()
            }
            return i
        }, collides: function (t) {
            ...
            if (!p(t, n)) return !1;
            for (var a, e, r, o, s = []; n;) {
                for (a = 0, e = n.children.length; a < e; a++) if (r = n.children[a], p(t, o = n.leaf ? i(r) : r)) {
            ...
            for (var i, a, e, o, s = this.data, h = this.toBBox(t), l = [], c = []; s || l.length;) {
                ...
                o || s.leaf || !_(s, h) ? a ? (i++, s = a.children[i], o = !1) : s = null : (l.push(s), c.push(i), i = 0, a = s, s = s.children[0])
            }
            return this
        }, toBBox: function (t) {
            return t
            ...
            a || (a = Math.ceil(Math.log(r) / Math.log(s)), s = Math.ceil(r / Math.pow(s, a - 1))), (e = g([])).leaf = !1, e.height = a;
            var h, l, c, m, u = Math.ceil(r / s), f = u * Math.ceil(Math.sqrt(s));
            for (x(t, n, i, f, this.compareMinX), h = n; h <= i; h += f) for (x(t, h, c = Math.min(h + f - 1, i), u, this.compareMinY), l = h; l <= c; l += u) m = Math.min(l + u - 1, c), e.children.push(this._build(t, l, m, a - 1));
            return o(e, this.toBBox), e
        }, _chooseSubtree: function (t, n, i, a) {
            for (var e, r, o, s, h, l, c, u; a.push(n), !n.leaf && a.length - 1 !== i;) {
                for (c = u = 1 / 0, e = 0, r = n.children.length; e < r; e++) h = m(o = n.children[e]), (l = f(t, o) - h) < u ? (u = l, c = h < c ? h : c, s = o) : l === u && h < c && (c = h, s = o);
                n = s || n.children[0]
            }
            return n
            ...
            var r = this._chooseSplitIndex(i, e, a), s = g(i.children.splice(r, i.children.length - r));
            ...
            this.data = g([t, n]), this.data.height = t.height + 1, this.data.leaf = !1, o(this.data, this.toBBox)
        }, _chooseSplitIndex: function (t, n, i) {
            var a, e, r, o, h, l, c, u;
            for (l = c = 1 / 0, a = n; a <= i - n; a++) o = d(e = s(t, 0, a, this.toBBox), r = s(t, a, i, this.toBBox)), h = m(e) + m(r), o < l ? (l = o, u = a, c = h < c ? h : c) : o === l && h < c && (c = h, u = a);
            return u
    ...
    t.exports = function (t) {
        var n = (t.Layer ? t.Layer : t.Class).extend({
            initialize: function (n) {
                ...
                var e = this._map.latLngToContainerPoint(i), r = n.options.icon.options.iconSize, o = r[0] / 2,
                    s = r[1] / 2, h = [{minX: e.x - o, minY: e.y - s, maxX: e.x + o, maxY: e.y + s, data: n}, {
                        minX: i.lng,
                        minY: i.lat,
                        maxX: i.lng,
                        maxY: i.lat,
                ...
                if (t.canvas_img) i._drawImage(t, n); else if (i._imageLookup[a]) t.canvas_img = i._imageLookup[a][0], !1 === i._imageLookup[a][1] ? i._imageLookup[a][2].push([t, n]) : i._drawImage(t, n); else {
                    var e = new Image;
                ...
                if (t.text) {
                    this._context.drawImage(t.canvas_img, n.x - i.iconAnchor[0], n.y - i.iconAnchor[1], i.iconSize[0], i.iconSize[1]), this._context.font = t.font, this._context.fillStyle = t.color;
                    var a = t.text + "";
                    1 == a.length ? a = "  " + t.text : 2 == t.text.length && (a = " " + t.text), this._context.fillText(a, n.x - t.x, n.y - t.y)
                } else this._context.drawImage(t.canvas_img, n.x - i.iconAnchor[0], n.y - i.iconAnchor[1], i.iconSize[0], i.iconSize[1])
            }, _reset: function () {
                ...
                if (t && this._context.clearRect(0, 0, this._canvas.width, this._canvas.height), this._map && this._latlngMarkers) {
                    ...
                    n._latlngMarkers.search(e).forEach(function (t) {
                        var a = n._map.latLngToContainerPoint(t.data.getLatLng()),
                            e = t.data.options.icon.options.iconSize, r = e[0] / 2, o = e[1] / 2,
